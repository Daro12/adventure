...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiZGFyb3Zhbjg5MTEiLCJhIjoiY2t1d3A2MGViMGJxbzMzbGFvMWU5dWE4OSJ9.48Fu3bTzKkuFA_JZt0IGlw";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            res = _context.sent;
            document.cookie = "jwt=".concat(res.data.token, "; max-age=1008min");
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe("pk_test_51JTH0FKNK1pOcnP8EMrd3NpsoUSrb1Qc8Gv04IKzJnRetBMc0RFhNOFLpxbgAAc3XUuTxZmUQT00QtBC25s2bmp900KtYJ6Eqv");
            _context.prev = 1;
            _context.next = 4;
